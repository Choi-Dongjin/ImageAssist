...
namespace ImageAssist
{
    public class ImageAssistExtension
    {
        ...
        {
            using Mat matIm = Cv2.ImRead(imPath);
            return ExtractCoordinatesMaskImage(matIm, out outMat);
        }
        ...
        public static (Point, Point)? ExtractCoordinatesMaskImage(Mat simRImage, out Mat? outMat)
        {
            ...
            List<int> xList = new();
            List<int> yList = new();
            //ImageAssist.SWImage(simROIImage);
